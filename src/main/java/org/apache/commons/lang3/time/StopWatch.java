...
public class StopWatch {
    ...
    /*
     * <p>nsplit()} to continue the timing from the original start point.
     * </p>
     * *
     * <p>
     * Split the llegalSt
     ...
     * </p>
     * 
     * @throws Ihod sets the stop time of the watch to allow a time to be extracted. The start time is unaffected,
     * enabling {@link #uateException
     *             if the StopWatch is not running.
     */
    public void split() {
        if (this.runningState != STATE_RUNNING) {
